...
<div class="jumbotron text-center efecto-abajo">
    <?php 
...
<div class="alert alert-danger efecto-abajo" style="font-family: Times New Roman; font-size: 22px;">
...
<div class="jumbotron text-center efecto-abajo">
    <form id="form" action="" method="post">
        ...
        <h2>Contacto</h2>
        <div class="form-row">
            <input type="text" maxlength="30" name="contacto" id="contacto" required />
            <label alt="Label" data-placeholder="Email/WhatsApp"></label>
        </div>
        
        <h2>Detalles del Servicio</h2>
        <textarea n ame="texto" id="texto" maxlength="500" required></textarea>
