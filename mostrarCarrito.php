...
<table class="table table-dark table-striped">
    <tbody>
        <tr>
            ...
            <th width="5%"><img class="img-fluid" src="http://subirimagen.me/uploads/20190126100442.png"></th>
        </tr>
        <?php $total=0;?>
        ...
        <?php } ?>
        <tr>
            <td colspan="3"><h3 style="font-family: Times New Roman; font-size: 30px; color: #1cb495">Total</h3></td>
            <td><h3 style="font-family: Times New Roman; font-size: 30px">$<?php echo number_format($total,2); ?></h3></td>
            <td></td>
        </tr>
...
<?php } else { ?>
<div class="alert alert-success productos">
