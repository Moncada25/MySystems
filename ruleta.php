...
<link rel="stylesheet" href="css/text.css">
    ...
    <header id="header">
        <img class="img-fluid" src="images/welcome.png">
    </header>

    <form id="form" action="players_data.php" method="post">
        <div class="form-row">
            <input maxlength="1" minlength="1" type="text" name="jugadores" id="players" onkeypress="return soloNumeros(event)" required />
