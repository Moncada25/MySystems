...
if (!$off) {
    ...
    if ($_POST['numeroGanador'] != 69) {
        ...
        echo "<div class='alert alert-success efecto-derecha'>";
...
<br>
<div id=canvasContainer class="efecto-derecha">
...
<form name=Ruleta method=post action=game.php>
    ...
    <br>
    <table class='table table-dark table-striped efecto-arriba'>
        <thead>
            <tr>
                <th>
                ...
                <th>
                    <div class=titulos>State</div>
                </th>
                <th>
                    <div class=titulos>Balance</div>
                </th>
                <th>
                    <div class=titulos>Bet Value</div>
                </th>
                <th>
                    <div class=titulos>Bet #</div>
                </th>
            </tr>
        </thead>
        <tbody>
